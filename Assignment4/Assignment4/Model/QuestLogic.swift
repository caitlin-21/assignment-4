...
struct QuestLogic {
    ...
    func getChoiceOne() -> String {
        return theQuest[state].choiceOne
    }
    
    func getChoiceTwo() -> String {
        return theQuest[state].choiceTwo
    }
    
    func getScene() -> String {
        return theQuest[state].scene
    }
    ...
    mutating func setState(_ inCon: Int) {
        state = inCon
    }
    
    func getConsequenceOne() -> Int {
        return theQuest[state].cons1
    }
    
    func getConsequenceTwo() -> Int {
        return theQuest[state].cons2
    }
}
